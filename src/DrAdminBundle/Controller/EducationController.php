...
use DrAdminBundle\Entity\Education;
...
class EducationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $educations = $em->getRepository('DrAdminBundle:Education')->findAll();

        return $this->render('DrAdminBundle:education:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('DrAdminBundle\Form\EducationType', $education);
        ...
        return $this->render('DrAdminBundle:education:new.html.twig', array(
            'education' => $education,
    ...
    public function showAction(Education $education)
    {
        ...
        return $this->render('DrAdminBundle:education:show.html.twig', array(
            'education' => $education,
    ...
    {
        $deleteForm = $this->createDeleteForm($education);
        $editForm = $this->createForm('DrAdminBundle\Form\EducationType', $education);
        ...
        return $this->render('DrAdminBundle:education:edit.html.twig', array(
            'education' => $education,
